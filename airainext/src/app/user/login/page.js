                    ...
                    <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                        ...
                        <div class="max-w-md mx-auto">
                            <div>
                                ...
                                <h1 class="text-xl font-semibold mt-1 text-gray-700">To start using Breeze</h1>
                            ...
                            <div class="divide-y divide-gray-200">
                                ...
                                <div className="flex justify-start mb-10">
                                    ...
                                    <div className=" text-center text-blue-500  text-sm">Already have an account? <a className="text-blue-500 underline" href="/login">Login instead</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
